...
<div class="all-wrapper menu-side with-pattern">
	<div class="auth-box-w">
		...
		<?php echo form_open('',array("id" => "myform3","enctype" => "multipart/form-data")); ?>

			<div class="form-group">
				<label for="">Username</label>
				<input class="form-control" name="email" placeholder="Enter your username" type="email">
			...
			<div class="form-group">
				...
				<a href="<?php echo ADMIN_URL; ?>forgotpassword">Forgot password?</a>
			</div>
			<div class="buttons-w">
